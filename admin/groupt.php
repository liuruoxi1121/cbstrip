        ...
        <div class="row">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <p class="pull-right" style="margin-top: 20px;">
              <a class="btn btn-success" href="groupt_add.php">添加</a>
            </p>
            <h2 class="sub-header">景点管理</h2>
                  ...
                  <?php
                    if(mysqli_affected_rows($conn)>0) {
                      ...
                      <tr>
                        ...
                        <td><?=$row["addtime"]?></td>
                        <td>
                          <a class="btn btn-success" href="groupt_change.php?id=<?=$row["id"]?>">修改</a>
                          <a class="btn btn-danger" href="dodelete.php?type=groupt&id=<?=$row["id"]?>">删除</a>
                        </td>
                      </tr>
                      <?php
                        }
