      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">酒店管理:新增酒店</h2>
            <form class="form-horizontal" action="do_hotel_add.php" method="post" enctype="multipart/form-data" autocomplete="off">
