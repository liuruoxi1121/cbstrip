...
$sql = "select orders.*,user.username as uname from `orders` left join user on orders.uid = user.id";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <p class="pull-right" style="margin-top: 20px;">            </p>
                  ...
                  <?php
                    if(mysqli_affected_rows($conn)>0) {
                      ...
                      <tr>
                        ...
                        <td><?=$row["addtime"]?></td>
                        <td>
                          <a class="btn btn-danger" href="dodelete.php?type=orders&id=<?=$row["id"]?>">删除</a>
                        </td>
                      </tr>
                      <?php
                        }
